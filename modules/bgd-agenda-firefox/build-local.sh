...
OUT="${2:-$HOME/BrasilGuard-Agenda-Firefox-v0003.c.xpi}"
BUILD="$(mktemp -d)"
...
for f in manifest.json config.js background.js popup.html popup.css popup.js v0003-guard.js calendar-premium.js commerce-guard.js options.html options.js; do
...
for f in manifest.json config.js background.js popup.html popup.css popup.js v0003-guard.js calendar-premium.js commerce-guard.js; do
